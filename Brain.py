...
dataset    = 'HDFS'
input_dir  = '/kaggle/input/loghub-hadoop-distributed-file-system-log-data/HDFS_2/' # The input directory of log file
...
file = 'hadoop-hdfs-datanode-mesos-02.log'
arr = []
for i in range(1, 33):
    if i!=4 and i!=24 and i!=12:
        num = str(i).zfill(2)
        string = f"hadoop-hdfs-datanode-mesos-{num}.log"
        arr.append(string)
...
for i in arr:
    parser.parse(i)    
# parser.printTree(parser.rootNode, 4)
